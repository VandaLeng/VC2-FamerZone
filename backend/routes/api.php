...
Route::get('/items/filtered', [ItemController::class, 'filter']); // Add this specific route
...
// Route::post('/user/update-image', [UserController::class, 'updateImage'])->middleware('auth:sanctum');
