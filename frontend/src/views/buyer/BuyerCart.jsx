...
const CartPage = () => {
  ...
  console.log("Cart Items in CartPage:", cartItems); // Debug log (already present)

  useEffect(() => {
    console.log("CartPage re-rendered with items:", cartItems);
  }, [cartItems]);
      ...
      <div className="bg-gray-50 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-3 mb-2">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">រទេះទិញឥវ៉ាន់</h1>
          </div>
