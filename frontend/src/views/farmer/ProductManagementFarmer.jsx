              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setFormData({
                    ...formData,
                    unit: e.target.value,
                    unit_kh: e.target.value === 'piece' ? 'កុំព្យូទ័រ' : texts.kh[e.target.value]
                  })}
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#228B22] focus:border-[#228B22] transition-colors ${
                      ...
                      <td className="py-4 px-6">
                        <div className="flex items-center gap-4">
                          <img
                            ...
                            alt={currentLanguage === 'kh' ? product.name_kh : product.name}
                            className="w-12 h-12 rounded-lg object-cover border border-gray-200"
                          />
                          <div>
                            <p className="font-semibold text-[#333333]">
                              {currentLanguage === 'kh' ? product.name_kh : product.name}
                            </p>
                          </div>
                        </div>
                      </td>
