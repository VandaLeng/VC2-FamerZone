...
export default function LoginForm({ currentLanguage = 'en', onClose, onLoginSuccess }) {
  ...
  const texts = {
    kh: {
      title: 'ចូលប្រើ',
      subtitle: 'ស្វាគមន៍មកកាន់ FramerZone',
      email: 'អ៊ីមែល',
      ...
      register: 'ចុះឈ្មោះ',
      passwordRequirements: 'លេខសម្ងាត់ត្រូវតែមានយ៉ាងហោចណាស់ ៨ តួអក្សរ',
      loggingIn: 'កំពុងចូល...',
      close: 'បិទ',
      loginSuccess: 'ចូលប្រើជោគជ័យ!',
      loginFailed: 'ការចូលប្រើបរាជ័យ។ សូមព្យាយាមម្តងទៀត។',
    },
    en: {
      title: 'Sign In',
      subtitle: 'Welcome to FramerZone',
      email: 'Email Address',
      emailPlaceholder: 'your@email.com',
      password: 'Password',
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border-2 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition-all duration-200 border-gray-200 hover:border-gray-300"
              />
            </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-3 border-2 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition-all duration-200 border-gray-200 hover:border-gray-300"
              />
              <button
                type="button"
