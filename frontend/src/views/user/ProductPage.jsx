...
const ITEMS_ENDPOINT = "http://localhost:8000/api/items"
...
export default function ProductsPage({ currentLanguage = "en" }) {
  ...
  const fetchFilteredProducts = async () => {
    ...
    const params = {
      ...
      // only send numeric category ids to API
      category: /^\d+$/.test(String(selectedCategory)) ? String(selectedCategory) : undefined,
  ...
  // Listen for productAdded event from farmer dashboard and refresh
  useEffect(() => {
